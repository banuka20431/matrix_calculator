        ...
        case SUB: {
            for(int j = 0; j < (matrices_n -1); j++) {
                ...
                if(rows[j] != dimension) {
                    ...
                    if(j == 0) {
                        subtract(matrices[j], matrices[j+1], answer_matrices[j], rows[j]);
                    } else {
                        subtract(answer_matrices[j-1], matrices[j+1], answer_matrices[j], rows[j]);
                    }
                }
            }
            printf("\nAnswer: ");
        ...
        case MUL: {
            for(int j = 0; j < (matrices_n -1); j++) {
                ...
                if(rows[j] != dimension) {
                    ...
                    if(j == 0) {
                        multiply(matrices[j], matrices[j+1], answer_matrices[j], rows[j]);
                    } else {
                        multiply(answer_matrices[j-1], matrices[j+1], answer_matrices[j], rows[j]);
                    }
                }
            }
            printf("\nAnswer: ");
        ...
        case DIV: {
            for(int j = 0; j < (matrices_n -1); j++) {
                ...
                if(rows[j] != dimension) {
                    ...
                    if(j == 0) {
                        divid(matrices[j], matrices[j+1], answer_matrices[j], rows[j]);
                    } else {
                        divid(answer_matrices[j-1], matrices[j+1], answer_matrices[j], rows[j]);
                    }
                }
            }
            printf("\nAnswer: ");
